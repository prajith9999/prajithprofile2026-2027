export const profile = {
  ...
  tagline: '.NET Full Stack · Cloud · DevOps',
  location: 'Doha, Qatar',
...
export const differentiators = [
  {
    ...
    desc: 'I build and maintain full-stack applications, REST APIs, and cloud deployments used in production environments.',
  },
  {
    label: 'Full Stack Depth',
    icon: 'server',
    title: 'End-to-End Ownership',
    desc: 'From React frontends to SQL Server databases, Azure/AWS hosting, and CI/CD pipelines — I cover the complete delivery stack.',
  },
  {
    label: 'Problem Solver',
    icon: 'chart',
    title: 'Understand the Why',
    desc: 'Strong in troubleshooting frontend, backend, database, and deployment issues with a focus on performance, security, and reliability.',
  },
];
